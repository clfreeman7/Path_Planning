...
- **GaitSynthesizer**
This handle class is used to syntehsize (generate) gaits by incorporating the motion primitive data. A demo is shown in [demo_GaitSynthesizer.m](https://github.com/clfreeman7/IROS2022/blob/main/demos/demo_GaitSynthesizer.m).
