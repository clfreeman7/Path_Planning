...
frame_start_list = [607, 103, 176, 226, 368, 259];      % for orange robot
...
for i = 1:n_gaits
    ...
    if i == 6
        filename = 'data/visualtracking/Gait E_2_corrected.mat';  
        gait_exp_2(i).params.marker_order = [1 2 3 4];
...
figure(1)
t = tiledlayout(1,2);
gait_exp_2(6).params.n_markers = 4;
gait_exp_2(6).params.pixel_length = 1/8.6343;
gait_exp_2(6).params.n_cycles= 60;
gait_exp_2(6).params.R_1= eul2rotm([deg2rad(112) 0 0]);
...
% Add colorbar.
set(gait_plot, 'CLim', [0 60])
a = colorbar(gait_plot(end));
