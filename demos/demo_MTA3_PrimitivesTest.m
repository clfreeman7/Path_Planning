...
frame_start_list = [148,28,187,151,159,110,91,107,110,89];
marker_order = repmat([1 2 4 6 5 3], 10,1);
marker_order(3,:) = [2 3 5 6 4 1];
marker_order([5,8],:) = repmat([1 3 5 6 4 2], 2,1);
...
for i = 1:10
    ...
    exp(i).params.substrate = 'black mat';
